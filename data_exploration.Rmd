...
# create box plots
plot_drive_mss <- ggplot(dep_scores_mss_drive, aes(x=dep_score)) +
  geom_boxplot() +
  coord_cartesian(xlim = limits) +
  xlab("Dependency Score") +
  ggtitle("MSS in DRIVE")

plot_achilles_mss <- ggplot(dep_scores_mss_achilles, aes(x=dep_score)) +
  geom_boxplot() +
  coord_cartesian(xlim = limits) +
  xlab("Dependency Score") +
  ggtitle("MSS in Achilles")

plot_drive_msi <- ggplot(dep_scores_msi_drive, aes(x=dep_score)) +
  geom_boxplot() +
  coord_cartesian(xlim = limits) +
  xlab("Dependency Score") +
  ggtitle("MSI in DRIVE")

plot_achilles_msi <- ggplot(dep_scores_msi_achilles, aes(x=dep_score)) +
  geom_boxplot() +
  coord_cartesian(xlim = limits) +
  xlab("Dependency Score") +
...
# show plots
plot_drive_mss + plot_drive_msi + plot_achilles_mss + plot_achilles_msi
```
